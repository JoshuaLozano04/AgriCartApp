...
Future<List<latlng.LatLng>> _getRoute(double startLat, double startLng, double endLat, double endLng, String token) async {
  try {
                            ...
                            FutureBuilder(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return FutureBuilder<List<latlng.LatLng>>(
                                  future: _getRoute(sellerLat, sellerLng, destLat, destLng, mapboxToken),
