...
class ChatSocketService {
  ...
  void _scheduleReconnect() {
    ...
    final delay = _reconnectBaseDelay * (1 << _reconnectAttempts); // Exponential backoff
    _reconnectAttempts++;
    
    debugPrint('ChatSocket: Reconnecting in ${delay.inSeconds}s (attempt $_reconnectAttempts)');
